...
export const createRecruitNotice = async (
  companyId,
  position,
  nation,
  area,
  ...
  return await recruitRepository.createRecruitNotice(
    companyId,
    position,
    nation,
    area,
...
export const updateRecruitNotice = async (
  companyId,
  position,
  nation,
  area,
  ...
  return await recruitRepository.updateRecruitNotice(
    companyId,
    position,
    nation,
    area,
